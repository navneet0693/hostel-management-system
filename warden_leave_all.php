...
<div class="panel panel-primary">
    <div class="panel-heading">
        <h2 class="panel-title"><h1><b>LEAVE LIST</b></h1></h2>
    </div>
    <table class="table">
        <th>SerialNo.</th><th>Student ID</th><th>Date From</th><th>Date Till</th><th>Reason</th>
        <?php
        while($row = mysql_fetch_array($res))
        {
        echo "<tr><td>".$sn."</td><td>" . $row['stuid']. "</td><td>" . $row['since'] ."</td><td>".$row['until']."</td><td>".$row['reason']. "</td></tr>";?><read only required><?php
            $sn++;
            }
            ?>
    </table>
