...
<p align="center"><u><b>View Student</b></u></p><br>
<div class="jumbotron vertical-center">
    <div class= "container">

        <form class="form-horizontal" role="form" action="stu_display.php" method="POST">
            <div class="form-group">
                <label class="control-label col-sm-4" for="studentID">Studnet ID:</label>
                <div class="col-sm-4">
