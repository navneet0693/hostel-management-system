...
$sn=1;
$v1=$_SESSION["id"];
$sql="Select * from leave_table where leave_table.stuid=$v1";
$res=mysql_query($sql);
if(!res)
{
...
<div class="panel panel-primary">
    <div class="panel-heading">
        <h2 class="panel-title"><h1><b><u>LEAVE LIST</u></b></h1></h2>
    </div>
    <table class="table">
        <th>SerialNo.</th><th>Date From</th><th>Date Till</th><th>Reason</th>
        <?php
        while($row = mysql_fetch_array($res))
        {
            echo "<tr><td>".$sn."</td><td>" . $row['since'] ."</td><td>".$row['until']."</td><td>".$row['reason']. "</td></tr>";?>
            <?php
            $sn++;
        }
        ?>
