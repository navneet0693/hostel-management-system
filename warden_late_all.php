...
<div class="panel panel-primary">
    <div class="panel-heading">
        <h2 class="panel-title"><h1><b>LATE NIGHT: LIST</b></h1></h2>
    </div>
    <table class="table">
        <th>SerialNo.</th><th>Student Id.</th><th>Day</th><th>Reason</th>
        <?php
        while($row = mysql_fetch_array($res))
        {
            echo "<tr><td>".$sn."</td><td>" .$row['stuid']."</td><td>" . $row['on_day'] ."</td><td>".$row['reason']. "</td></tr>";
            $sn++;
        }
        ?>
    </table>
