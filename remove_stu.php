...
<p align="center" color="red"><b>STUDENT WILL BE PERMANENTLY REMOVED</b></font></p><br>
<div class="jumbotron vertical-center">
    <div class= "container">

        <form class="form-horizontal" role="form" action="remove_stu_db.php" method="POST">
            ...
            <div class="form-group">
                <div class="col-sm-offset-4 col-sm-5">
                    ...
                    <button class="btn btn-pimary" type="reset">Reset</button>
                </div>
            </div>
        </form>
    </div>
