...
<p align="center"><u>Fill in the information to add a leave</u></p>
<div class= "jumbotron vertical center">
    <form class="form-horizontal" role="form" action="warden_add_leave.php" method="POST">
        <div class="form-group">
            <label class="control-label col-sm-4" for="studentID">Student ID:</label>
            <div class="col-sm-4">
                <input type="text" name="stuid" class="form-control" id="studentID" placeholder="Student's JIET ID" autofocus required>
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-sm-4" for="studentID">From:</label>
            <div class="col-sm-4">
                <input type="date" name="since" autofocus required>
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-sm-4" for="studentID">Until:</label>
            <div class="col-sm-4">
                <input type="date" name="until" autofocus required>
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-sm-4" for="com">Reason:</label>
            <div class="col-sm-4">
                <textarea rows="7" name="res" placeholder="Describe the issue"></textarea>
            </div>
        </div>
